...
"recommend themes: desert molokai eclm_wombat vividchalk railscasts
set guioptions-=T
if has("gui_running")
...
nnoremap <leader>] :FuzzyFinderTextMate<CR>
...
let g:fuzzy_ignore = "public_stub/storage/**;log/**;coverage/*;gems/*;tmp/*;*.log;*.svn;*.swp;*.jpg;*.gif;*.png;*~"
set cursorline
